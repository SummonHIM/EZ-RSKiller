...
echo 已将 REDAgent.exe 重命名为 REDAgent.0
echo 正在完成！
...
if errorlevel 1 (goto NoAccess)
echo 已将 REDAgent.0 重命名为 REDAgent.exe
echo 正在强制启动红蜘蛛软件...
...
echo,
echo 本脚本易被管理员爆破，建议用纸笔记下永久网址：ez.summonhim.xyz
echo 本脚本易被管理员爆破，建议用纸笔记下永久网址：ez.summonhim.xyz
echo 本脚本易被管理员爆破，建议用纸笔记下永久网址：ez.summonhim.xyz
msg * 本脚本易被管理员爆破，建议用纸笔记下永久网址：ez.summonhim.xyz
